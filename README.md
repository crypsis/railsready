...
###To run:
####Linux
  * `wget --no-check-certificate https://raw.githubusercontent.com/crypsis/railsready/master/railsready.sh && bash railsready.sh`

####OSX
  * `curl -O https://raw.githubusercontent.com/crypsis/railsready/master/railsready.sh && bash railsready.sh`
